...
#  CTRL-C is disabled by default. You can enable it by commenting out "trap '' 2" below
...
#  CTRL-C is disabled by default. You can enable it by commenting out this variable
#  Doing a "CTRL-C" will disable output to the file with last temperatures however
trap '' 2
